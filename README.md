...
This project leverages machine learning to predict language endangerment across five levels, from Not Endangered to Extinct. Using socio-economic and geographic features such as speaker counts, political recognition, and internet access, it applies multiple modeling techniques to surpass baseline performance, demonstrating how data science can support linguistic preservation efforts.
